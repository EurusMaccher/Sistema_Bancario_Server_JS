# Sistema de Server Bancario
### By: Eurus - Renato Pedrozo

### O que esse repositorio contem:

codigos completo da resolução do desafio proposto, dividido em 4 arquivos principais:

- index.js = responsavel pela comunicação entre os arquivos e o servidor

- roteador.js = responsavel por organizar as rotas dos endpoints.

- controlador.js = responsavel pelas implementações das funcionalidades propostas no desafio.

- bancodedados = arquivo por qual toda informação de entrada e saida passará 
